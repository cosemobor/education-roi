...
export default function DotPlot({ majorsSummary, schoolRankings }: DotPlotProps) {
  ...
  // Table sort — default to 5yr earnings desc (primary visible column)
  const [sortField, setSortField] = useState<SortField>('earn5yr');
              ...
              <table className="w-full text-xs">
                <thead className="sticky top-0 bg-gray-50 text-left">
                  <tr>
                    ...
                    >
                      <span className="sm:hidden">5yr</span>
                      <span className="hidden sm:inline">5yr Earnings</span>
                      {sortArrow('earn5yr')}
                    </th>
                    <th
